...
<?php
    ...
    if($_POST['fecha_emision']){
        $fecha_emision = "fecha_emision = '".$_POST['fecha_emision']." ".$_POST['hora_emision']."',";
    }
    ...
    $sql = mysqli_query($link, "INSERT INTO documentos
                                ...
                                id_documento_padre = '".$_POST['id_documento_padre']."',
                                fecha_actualizacion = '".date('Y-m-d H:i:s')."';   ");
    
    $jsonData['error_documentos'] = mysqli_error($link)." - ".$_POST['destinatario']." - ".$id_destinatario;
