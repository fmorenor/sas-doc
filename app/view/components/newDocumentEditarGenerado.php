...
<script src="controller/components/newDocumentEditarGenerado.js"></script>
            ...
            <div id="newDocumentScroll">
                ...
                <div class="row-fluid">
                    <div class="span6">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fecha_emision_generado"><strong>Fecha emisión *</strong></label>
                            <div class="controls">
